...
if(isset($_POST['register'])){
  ...
  if(isset($_FILES['profile'])){
      ...
      if(empty($errors)==true){
          ...
          echo "<script>window.location.href = 'http://localhost:82/ebookpro/admin/register.php';</script>";
          die();
      }
                ...
                <div class="card-body">
                  ...
                  <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <input type="file" name="profile" class="form-control" id="yourPassword" required>
